...
namespace Claim.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(IQueryService<User, ClaimsPrincipal> createPrincipalService, IQueryService<EntryDTO, User?> entryService)
        {
            ArgumentNullException.ThrowIfNull(createPrincipalService);
            ArgumentNullException.ThrowIfNull(entryService);
            _createPrincipalService = createPrincipalService;
            _entryService = entryService;
        }

        [BindProperty]
        public EntryDTO Input { get; set; }
